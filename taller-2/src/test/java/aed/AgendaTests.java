...
public class AgendaTests {
  ...
  void agregarRecordatorios() {
    ...
    a.agregarRecordatorio(
        new Recordatorio("Clase Algoritmos", new Fecha(10, 05), new Horario(17, 00)));
    a.agregarRecordatorio(
        new Recordatorio("Labo Algoritmos", new Fecha(10, 05), new Horario(19, 00)));
  ...
  void incrementarDiaModificaRecordatorios() {
    ...
    a.agregarRecordatorio(
        new Recordatorio("Clase Algoritmos", new Fecha(10, 05), new Horario(17, 00)));
    a.agregarRecordatorio(
        new Recordatorio("Partido de Fútbol", new Fecha(11, 05), new Horario(19, 00)));
    a.agregarRecordatorio(
        new Recordatorio("Labo Algoritmos", new Fecha(10, 05), new Horario(19, 00)));
