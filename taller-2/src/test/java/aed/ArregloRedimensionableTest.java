...
class ArregloRedimensionableTest {
  ...
  void copiarVector() {
    ...
    assertEquals(
        new Recordatorio("1", new Fecha(1, 1), new Horario(0, 0)), copiaDeVector.obtener(0));
    assertEquals(
        new Recordatorio("2", new Fecha(1, 2), new Horario(0, 1)), copiaDeVector.obtener(1));
    assertEquals(
        new Recordatorio("3", new Fecha(1, 3), new Horario(0, 2)), copiaDeVector.obtener(2));
    assertEquals(
        new Recordatorio("4", new Fecha(1, 4), new Horario(0, 3)), copiaDeVector.obtener(3));
    assertEquals(
        new Recordatorio("5", new Fecha(1, 5), new Horario(0, 4)), copiaDeVector.obtener(4));
  }
  ...
  void copiarVectorConstructor() {
    ...
    ArregloRedimensionableDeRecordatorios copiaDeVector =
        new ArregloRedimensionableDeRecordatorios(vector);
